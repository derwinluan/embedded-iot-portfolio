...
| :--- | :--- | :--- |
| **Raspberry Pi 4B** | Main controller for managing the LED matrix GPIO timings. | 📷![RaspberryPi_01]([https://githubusercontent.com](https://github.com/derwinluan/embedded-iot-portfolio/blob/main/image/RaspberryPi4B-LED/RaspberryPi_01.jpg))
|
